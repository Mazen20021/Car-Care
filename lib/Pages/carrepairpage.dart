    ...
    return Scaffold(
      appBar: AppBar(
        ...
        children: [
          IconButton(onPressed: (){
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) =>  MainPageService(isCarSelected: true,userName: "Mazen",currentIndex: widget.carIndex,)),
            );
          }, icon: const Icon(Icons.arrow_back_ios_new_rounded))
          , SizedBox(width: Screen.size.width * 0.35),
          Text(
            "Add A Car Repair",
        ...
        body: SingleChildScrollView(
          physics: _isExpanded1? const AlwaysScrollableScrollPhysics():const NeverScrollableScrollPhysics(),
                  ...
                  Transform.translate(
                    ...
                    width: Screen.size.width * 0.98,
                      child: TextFormField(
                        ...
                        Transform.translate(offset: const Offset(2, 0),
                            child: Row(children: [
                             Text("Cant find your repair",style: GoogleFonts.rubik(
                                fontWeight: FontWeight.bold,
                                color: MainColors.black,
                                fontSize: Fonts.x2s())),
                            TextButton(onPressed: (){}, child: const Text("Add new repair part"))
                          ],)),
                          Transform.translate(offset: const Offset(2, -20),
                              child: Row(
                            children: [
                             Text("Want to configure car repair",style: GoogleFonts.rubik(
                                fontWeight: FontWeight.bold,
                                color: MainColors.black,
                                fontSize: Fonts.x2s())),
                            TextButton(onPressed: (){}, child: const Text("Change Repair Milestone"))
                          ],)),
                        Transform.translate(offset: const Offset(-20, -5),
                          child: Row(children: [
                            ButtonClass(
                                width: 180,
                                height: 50,
                            ...
                            ButtonClass(
                                ...
                                hasGradient: true,
                                gradientColors: const [
                                  Color.fromARGB(255, 180, 74, 80), Color.fromARGB(255, 181, 74, 80)
                                ],
                                hasImage: true,
                                imagePath: "assets/image/loginBackground.png",
                                imageOpacity: 0.1,
