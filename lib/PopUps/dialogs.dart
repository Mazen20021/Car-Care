    ...
    showDialog(
      ...
      builder: (BuildContext context) {
              ...
              Row(
                ...
                Padding(padding: const EdgeInsets.all(16),
                    child: CustomButton(
                        ...
                        height: 40,
                        hasGradient: true,
                        gradientColors: const [MainColors.white, MainColors.white,],
                        hasImage: false,
                        imagePath: "",
                        imageOpacity: 0.1,
        ...
        SizedBox(
          ...
          child: Center(
          child: Container(
            decoration:  BoxDecoration(color: MainColors.white , borderRadius: BorderRadius.circular(20)),
            child: Column(
              children: [
                const Image(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      border: OutlineInputBorder(
                        ...
                        borderSide: const BorderSide(color: MainColors.deepPurple, width: 2.0),
                      ),
                      enabledBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(10),
                        borderSide: const BorderSide(color: MainColors.black, width: 1),
                      ),
                      ...
                      errorBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(10),
                        borderSide: const BorderSide(color: MainColors.redAccent, width: 2.0),
                      ),
                ...
                Transform.translate(offset: const Offset(-0.37, 50),child:
                Center(
                  child: Row(
                    ...
                    children: [
                      ...
                      Padding(padding: const EdgeInsets.all(0) , child:  Container(
                        width: 2,
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color.fromARGB(255, 12, 21, 52),
                            shape: const RoundedRectangleBorder(
                              borderRadius: BorderRadius.only(
