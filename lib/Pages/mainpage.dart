                        ...
                        children: [
                          Transform.translate(
                            ...
                            child:Container(
                              width: 180,
                              height: 50,
                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: MainColors.primary.withOpacity(0.5)),
                              child:Center(
                                child: Row(
                                  mainAxisSize: MainAxisSize.min,
                                  children: [
                                    Text("Record Odometer", style: GoogleFonts.rubik(fontWeight: FontWeight.bold, color: MainColors.white, fontSize: Fonts.x2s())),
                                    const SizedBox(width: 10),
                                    GestureDetector(
                                        onTap: (){},
                                        child: Container(
                                          width: 30,
                                          height: 30,
                                          decoration: BoxDecoration(color: MainColors.white,borderRadius: BorderRadius.circular(10)),
                                          child:  Icon(Icons.add,color: MainColors.primary.withOpacity(0.5)),
                                        )),
                                  ],),
                              ),
                            ),
                            ...
                            child:Container(
                              ...
                              child:Center(
                                child: Row(
                                  mainAxisSize: MainAxisSize.min,
                                  children: [
                                    Text("New car repair", style: GoogleFonts.rubik(fontWeight: FontWeight.bold, color: MainColors.white, fontSize: Fonts.x2s())),
                                    const SizedBox(width: 20),
                                    GestureDetector(
                                        onTap: (){},
                                        child: Container(
                                          ...
                                          height: 30,
                                          decoration: BoxDecoration(color: MainColors.white,borderRadius: BorderRadius.circular(10)),
                                          child:  Icon(Icons.handyman_rounded,color: MainColors.primary.withOpacity(0.5)),
                                        )),
                                  ],),
                              ),
                            ),
                            ...
                            children: [Row(
                              children: [
                                Container(
                                  width: 40,
                                  height:40 ,
                                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color:Color.fromARGB(255, 12, 21, 52)),
                                  child: const Icon(Icons.handyman_rounded,color: MainColors.white,),
                                ),
                                const SizedBox(width: 10),
                                Text("Upcoming Checks", style: GoogleFonts.rubik(
                                    fontWeight: FontWeight.bold,
                                ...
                                IconButton(
                                  ...
                                  icon: Icon(!_isExpanded1 ? Icons.keyboard_arrow_down_rounded :  Icons.keyboard_arrow_up_rounded,size: 30,),
                                ),],), AnimatedContainer(
                              duration: const Duration(milliseconds: 220),
                              height: _isExpanded1 ?(!_isCarSelected? 60 : 250) : 0, // Adjust the height as needed
                              child: ListView(
                                children: List.generate(!_isCarSelected? 1 : 5, (index) {
                                  return ListTile(
                                    title: !_isCarSelected? Row(children: [Text("Add car to see upcoming checks",style: GoogleFonts.rubik(
                                        fontWeight: FontWeight.bold,
                                        color: MainColors.black,
                                        fontSize: Fonts.x2s())),const SizedBox(width: 5) ,
                                      GestureDetector(child: Text("Add Car",style: GoogleFonts.rubik(
                                          fontWeight: FontWeight.bold,
                                          color: MainColors.primary,
                                          fontSize: Fonts.x2s())
                                      )
                              ...
                              Row(
                                children: [
                                  Container(
                                    width: 40,
                                    height:40 ,
                                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color:const Color.fromARGB(255, 12, 21, 52)),
                                    child: const Icon(Icons.calendar_month_rounded,color: MainColors.white,),
                                  ),
                                  const SizedBox(width: 10),
                                  Text("Upcoming Events", style: GoogleFonts.rubik(
                                      fontWeight: FontWeight.bold,
                                      color: const Color.fromARGB(255, 12, 21, 52),
                                      fontSize: Fonts.xs())),
                                  ...
                                  IconButton(
                                    ...
                                    icon: Icon(!_isExpanded2 ? Icons.keyboard_arrow_down_rounded :  Icons.keyboard_arrow_up_rounded,size: 30,),
                                  ),],),
                              AnimatedContainer(
                                duration: const Duration(milliseconds: 220),
                                height: _isExpanded2 ?(!_isCarSelected? 60 :250) : 0, // Adjust the height as needed
                                child: ListView(
                                  children: List.generate(!_isCarSelected? 1 : 5, (index) {
                                    return ListTile(
                                      title: !_isCarSelected? Row(children: [Text("Add car to see upcoming events",style: GoogleFonts.rubik(
                                      fontWeight: FontWeight.bold,
                                      color: MainColors.black,
                                      fontSize: Fonts.x2s())),const SizedBox(width: 5) ,
                                        GestureDetector(child: Text("Add Car",style: GoogleFonts.rubik(
          ...
          children: [
            Transform.translate(
              ...
              child:Container(
                width: 180,
                height: 50,
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: MainColors.primary),
                child:Center(
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      ...
                      GestureDetector(
                          ...
                          child: Container(
                            ...
                            height: 30,
                            decoration: BoxDecoration(color: MainColors.white,borderRadius: BorderRadius.circular(10)),
                            child:  Icon(Icons.add,color: MainColors.primary),
                          )),
                    ],),
                ),
              ),
                    ...
                    children: [
                      ...
                      GestureDetector(
                          ...
                          child: Container(
                            ...
                            height: 30,
                            decoration: BoxDecoration(color: MainColors.white,borderRadius: BorderRadius.circular(10)),
                            child:  Icon(Icons.handyman_rounded,color: MainColors.primary),
                          )),
                    ],),
                ),
              ),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [Row(
                ...
                duration: const Duration(milliseconds: 220),
                height: _isExpanded1 ?(!_isCarSelected? 80 :250) : 0, // Adjust the height as needed
                child: ListView(
                  children: List.generate(!_isCarSelected? 1 : 5, (index) {
                    return ListTile(
                      title: !_isCarSelected? Row(children: [const Text("Add car to see upcoming checks"),const SizedBox(width: 3) ,
                        GestureDetector(child: Text("Add Car",style: GoogleFonts.rubik(
                            fontWeight: FontWeight.bold,
                            color: MainColors.primary,
                            fontSize: Fonts.xs())))
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                AnimatedContainer(
                  duration: const Duration(milliseconds: 220),
                  height: _isExpanded2 ?(!_isCarSelected? 80:250) : 0, // Adjust the height as needed
                  child: ListView(
                    children: List.generate(!_isCarSelected? 1 : 5, (index) {
                      return ListTile(
                        title: !_isCarSelected? Row(children: [Text("Add car to see upcoming events"),SizedBox(width: 3) ,
                          GestureDetector(child: Text("Add Car",style: GoogleFonts.rubik(
                              fontWeight: FontWeight.bold,
                              color: MainColors.primary,
                              fontSize: Fonts.xs())))
