...
class CarNotSelectedPage extends StatefulWidget
{
  ...
  const CarNotSelectedPage({required this.userName , required this.currentIndex,super.key});
                         ...
                         children: [
                           Transform.translate(
                             ...
                             child:Container(
                               ...
                               decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: MainColors.primary.withOpacity(0.5),
                                 image: DecorationImage(image: const AssetImage("assets/fuelMeter.png"),fit: BoxFit.cover
                                   ,colorFilter: ColorFilter.mode(
                                     MainColors.primary.withOpacity(0.8), // Apply the same color as the container
                           ...
                           Transform.translate(
                             ...
                             child:Container(
                               ...
                               height: 50,
                               decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),color: MainColors.primary.withOpacity(0.5)
                                 , image: DecorationImage(image: const AssetImage("assets/repair.png"),fit: BoxFit.cover
                                   ,colorFilter: ColorFilter.mode(
                                     MainColors.primary.withOpacity(0.8), // Apply the same color as the container
                                     BlendMode.srcATop, // Blends the color with the image
                                   ),
                                   ...
                                   return ListTile(
                                       ...
                                       Column(
                                           ...
                                           children: [Row(children: [
                                             Transform.translate(offset: const Offset(0, -30) , child:
                                             Text("Add car to see upcoming checks",style: GoogleFonts.rubik(
                                                 fontWeight: FontWeight.bold,
                         ...
                         child: Container(
                           ...
                           child: Column(
                             ...
                             children: [
                               ...
                               AnimatedContainer(
                                 duration: const Duration(milliseconds: 220),
                                 height: _isExpanded2 ?( 60 ) : 0, // Adjust the height as needed
                                 child: ListView(
                                   shrinkWrap: true,
                                   physics: const NeverScrollableScrollPhysics(),
                                   children: List.generate( 1 , (index) {
                                     return ListTile(
                                       ...
                                       Column(
                                           ...
                                           children: [
                                             Row(children: [
                                               Transform.translate(offset: const Offset(0, -30) , child:
                                               Text("Add car to see upcoming events",style: GoogleFonts.rubik(
                                                   fontWeight: FontWeight.bold,
                                                   color: MainColors.black,
                                                   fontSize: Fonts.x2s()))),const SizedBox(width: 5) ,
                                               Transform.translate(offset: const Offset(0, -30) , child:
